...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">      
      ...
      <li><a href="<?php echo base_url().'index.php/lapadm' ?>">LAPORAN</a></li>
    </ul>
...
<input type="text" name="keyword" id="keyword" class="form-control"
 placeholder="Kode Dosen/Nama Dosen">
  ...
  <div class="row">
      <div class="col-lg-6">
          ...
          <h1>Data Dosen Pembimbing</h1>
            <a class="btn btn-primary" href="<?php echo base_url('index.php/dosen/create') ?>"><i class="fa fa file"></i>Create</a>
              <table width="150%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <?php foreach ($dosen as $m){
                  echo "<tr>
                    <td>$m->nmdospem</td>
                    <td>$m->kddospem</td>                                
                    <td>".anchor('dosen/edit/'.$m->kddospem,'Edit')."
                        ".anchor('dosen/delete/'.$m->kddospem,'Delete')."
                    </td>
                  </tr>";                                  }
                ?>
                </tbody>
